...
const SlideList = [
    {
        ...
        bgImage: 'bg_image-one',
        category: '',
        title: 'Marriages.',
        description: 'Exclusive Events, Priceless memories. Your dreams, delivered with blessings.',
        buttonText: 'Contact Us',
        buttonLink: '/contact'
    },
    {
        textPosition: 'text-center',
        bgImage: 'bg_image-two',
        category: '',
        title: 'Birthdays.',
        description: 'It’s your birthday, but you are a Gift!',
        buttonText: 'Contact Us',
        buttonLink: '/contact'
    },
    {
        textPosition: 'text-center',
        bgImage: 'bg_image-three',
        category: '',
        title: 'House warming.',
        description: 'New Address, New Memories, New Dreams, New Gifts packed with Wishes and Blessings.',
        buttonText: 'Contact Us',
        buttonLink: '/contact'
    }
]
